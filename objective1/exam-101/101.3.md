...
# Apenas em sistemas com Systemd
systemctl isolate runlevel6.target
```

### /etc/inittab

Em distribuições mais antigos com o SysVinit o arquivo onde define o runlevel padrão é o `/etc/inittab`.
...
# define de forma manual o runlevel padrão para 1 (usuário único ou recuperação)
